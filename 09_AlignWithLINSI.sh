...
outFile="$alignmentDir/$base.alignment.LINSI.fasta"
...
# Align the sequences with MAFFT-LINSI
mafft --maxiterate 1000 --localpair --thread $numTreads $inputSequences > $outFile
