...
# Must carry the same "-e " prefix the --extension/-e case branch below
# produces (extension="-e $1") - this default is forwarded as-is to
# 12_ConvertTreesToFigures.sh, which otherwise sees the bare word
# "treefile" as an unrecognized option ("Bad option treefile is
# ignored"). Confirmed 2026-08-03: currently harmless only by
# coincidence, since 12_ConvertTreesToFigures.sh's own internal default
# also happens to be "treefile".
