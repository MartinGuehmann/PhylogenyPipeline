...
#  --suffix (-x)
#     The suffix of the Newick tree files, the default is
#     "tre", which is the suffix used by PASTA, alternatives
#     are "contree" and "treefile", which are used by IQ-Tree
#
...
# These are generated by PASTA
# Alternatives are "contree" and "treefile" generated by IQ-Tree
extension="contree"
